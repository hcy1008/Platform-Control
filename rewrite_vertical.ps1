# PowerShell script to rewrite all damaged XAML files with proper UTF-8 encoding
...
# VerticalPipe.xaml
$verticalPipe = @"
<UserControl x:Class="Platform_Control.Controls.Pipeline.VerticalPipe"
...
[System.IO.File]::WriteAllText("$baseDir\Controls\Pipeline\VerticalPipe.xaml", $verticalPipe, $utf8NoBom)
Write-Host "Written VerticalPipe.xaml"
