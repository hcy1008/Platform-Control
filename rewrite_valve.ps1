# PowerShell script to rewrite ValveControl.xaml

$baseDir = "d:\Hcy\项目\平台domo\Platform-Control\Platform-Control"
$utf8NoBom = New-Object System.Text.UTF8Encoding $false

$valveControl = @"
<UserControl x:Class="Platform_Control.Controls.Pipeline.ValveControl"
    ...
    <UserControl.Resources>
        ...
        <RadialGradientBrush x:Key="HandWheelGlossBrush" Center="0.5,0.5" GradientOrigin="0.4,0.3">
            ...
            <GradientStop Offset="0.3" Color="#4DFFFFFF"/>
            ...
            <Ellipse Width="45" Height="45">
                <Ellipse.Fill>
                    <RadialGradientBrush Center="0.5,0.5" GradientOrigin="0.4,0.3">
                        ...
                        <GradientStop Offset="0.5" Color="#1AFFFFFF"/>
                        <GradientStop Offset="1" Color="#00FFFFFF"/>
                    </RadialGradientBrush>
                </Ellipse.Fill>
            </Ellipse>
...
[System.IO.File]::WriteAllText("$baseDir\Controls\Pipeline\ValveControl.xaml", $valveControl, $utf8NoBom)
Write-Host "Written ValveControl.xaml"
